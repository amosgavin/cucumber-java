...
import com.example.cucumber.stepdefs.Hooks;
...
@CucumberOptions(plugin = "pretty", features = "src/test/features",
        glue = {"cucumber.api.spring", "classpath:com.olr.test.evolve.cucumber.stepdefs"},
        tags = {"~@bug", "~@exclude"})

public class CukesRunner extends Hooks {
    ...
    @Test(suiteName = "cucumber", dataProvider = "features")
